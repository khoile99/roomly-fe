    ...
    <View style={styles.container}>
      <View style={styles.innerContainer}>
        <View>
          ...
          <Text>
            {i18n.t(LocalizationKey.ENTER_REGISTER)}
          </Text>
        </View>
        <TextInput placeholder={i18n.t(LocalizationKey.LAST_NAME)} style={styles.input}></TextInput>
        <TextInput placeholder={i18n.t(LocalizationKey.FIRST_NAME)} style={styles.input}></TextInput>
        ...
        <View style={styles.btnContainer}>
          <Button style={{ width: "100%" }}>{i18n.t(LocalizationKey.REGISTER)}</Button>
